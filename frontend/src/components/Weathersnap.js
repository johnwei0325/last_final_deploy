...
const WeatherSnap = () => {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        <i className="fa-solid fa-wind hey"></i>
        , React.createElement(
          "span",
          { className: "weather-temperature-value" },
      ...
      // <WbCloudyOutlinedIcon className="weather-type"/>
      React.createElement(
      "span",
      { className: "weather" },
     
      (weatherElement.description.includes('雨')?<i class="fa-solid fa-cloud-rain"></i>:(weatherElement.description.includes('雲')? <i class="fa-solid fa-cloud"></i> :<i className="weather-type fa-regular fa-sun" />))
      ,
      React.createElement(
        "span",
        { className: "weather-temperature-value" },
